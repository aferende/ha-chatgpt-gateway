...
Companion lifecycle logs use compact English messages with human-readable UTC timestamps. Request-result audit events remain structured JSON with ISO-8601 UTC timestamps. They contain metadata only: never bearer tokens, Authorization headers, Supervisor response bodies, or returned Core-log content.
